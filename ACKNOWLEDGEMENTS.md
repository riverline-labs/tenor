...
- [DeepSeek](https://chat.deepseek.com) - Beyond spec pressure testing, DeepSeek contributed thoughtful design suggestions that made it into the final spec, including the early flagging of a "contract discovery" mechanism that allows agents to discover and orient themselves around contracts in a decentralized system.
