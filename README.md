...
Documentation lives in the [tenor-docs](https://github.com/riverline-labs/tenor-docs) repo.
...
# Run conformance suite (127 tests)
cargo run -p tenor-cli -- test conformance

# Run all tests (849 workspace + 127 conformance)
