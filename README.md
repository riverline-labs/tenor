...
conformance/              -- elaborator conformance suite (119 tests)
...
# Run conformance suite (119 tests)
cargo run -p tenor-cli -- test conformance

# Run all tests (849 workspace + 119 conformance)
