...
function MoneyParams({
  ...
  return (
    <label className="flex flex-col gap-1">
      <span className="text-xs text-muted-foreground">Currency (ISO 4217)</span>
      <input
        type="text"
        value={currency}
        placeholder="USD"
        ...
        className="rounded-md border border-input bg-background px-2 py-1 text-sm uppercase"
      />
    </label>
  );
}
...
function TextParams({
  ...
  return (
    <label className="flex flex-col gap-1">
      <span className="text-xs text-muted-foreground">Max length (optional)</span>
      <input
        type="number"
        min={1}
        value={maxLength ?? ""}
...
function IntParams({
  ...
  return (
    <div className="flex gap-2">
      ...
      <label className="flex flex-1 flex-col gap-1">
        <span className="text-xs text-muted-foreground">Max (optional)</span>
        <input
          type="number"
          value={max ?? ""}
          placeholder="none"
...
function EnumParams({
  ...
  return (
    <div className="space-y-1">
      ...
      <button
        onClick={addValue}
        className="rounded-md border border-dashed border-border px-2 py-1 text-xs text-muted-foreground hover:bg-muted"
      >
        + Add value
      </button>
    </div>
