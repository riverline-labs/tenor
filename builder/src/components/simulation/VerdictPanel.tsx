...
function VerdictCard({ verdict, ruleInfo, onClick }: VerdictCardProps) {
  ...
  return (
    <button
      onClick={onClick}
      className="group flex w-full items-start gap-3 rounded-md border border-border bg-card p-3 text-left hover:border-primary/50 hover:bg-muted transition-colors"
    >
      {/* Indicator */}
      <div
        ...
        <div className="flex items-baseline justify-between gap-2">
          ...
          <span
            className={`shrink-0 text-sm font-medium ${
              truthy ? "text-primary" : "text-destructive"
            }`}
          >
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex items-center justify-between border-b border-border bg-card px-3 py-2">
        <h2 className="text-sm font-semibold text-foreground">Verdicts</h2>
