//! Human-in-the-loop policy: HumanInTheLoopPolicy, ApprovalChannel impls.
...
use crate::policy::{AgentPolicy, AgentSnapshot, ApprovalChannel, ApprovalResult, TimeoutBehavior};
...
mod tests {
    use super::*;
    use crate::policy::basic::{FirstAvailablePolicy, PriorityPolicy};
