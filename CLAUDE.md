...
- The language specification (see [tenor-docs](https://github.com/riverline-labs/tenor-docs)) when referring to formal construct definitions as concepts
...
- **Language specification:** `docs/tenor-language-specification.md` (source of truth, stays in this repo)
- **DSL syntax reference:** `docs/dsl-syntax.md` (canonical, parser-coupled, stays in this repo)
- **All other documentation:** https://github.com/riverline-labs/tenor-docs

## Repository layout

```
docs/tenor-language-specification.md   — full formal specification (v1.0)
docs/dsl-syntax.md                    — DSL quick-reference (parser-coupled)
